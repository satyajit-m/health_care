...
class ProfilePagePat extends StatefulWidget {
  ProfilePagePat({Key key}) : super(key: key);

  @override
  ProfilePagePatState createState() => ProfilePagePatState();
}

class ProfilePagePatState extends State<ProfilePagePat> {
                    ...
                    return ListView(
                      children: <Widget>[
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(8),
                              color: Colors.deepOrange[50].withOpacity(0.85)),
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: <Widget>[
                              Container(
  ...
  getUserDetails(String phone) {
    dynamic snapData =
        Firestore.instance.collection('users').document(phone).snapshots();
    return snapData;
  }
}
